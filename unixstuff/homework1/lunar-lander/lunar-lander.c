...
* lunar-lander.c
*
* Copyright 2014 Lukas F�lling <lukas@k40s.net>
* Copyright 2014 Nicolai S�per
*
...
#define ue (unsigned char)129		/* Definition for � */

int calculate(int height, int speed, int burn, int gravtiy) {
    return  (speed + gravtiy - burn);
}
